...
%% TrainingValidation dataset

PATH_READ = 'datasets/TrainingValidation/Image';
PATH_WRITE = 'datasets/TrainingValidation/4D';
...
PATH_READ = 'datasets/Test/Image';
PATH_WRITE = 'datasets/Test/4D';
